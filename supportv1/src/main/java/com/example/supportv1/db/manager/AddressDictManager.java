package com.example.supportv1.db.manager;
...
import com.example.supportv1.bean.AdressBean;
...
import com.example.supportv1.db.AssetsDatabaseManager;
import com.example.supportv1.db.TableField;

import java.util.ArrayList;
import java.util.List;

import static com.example.supportv1.db.TableField.ADDRESS_DICT_FIELD_CODE;
import static com.example.supportv1.db.TableField.ADDRESS_DICT_FIELD_ID;
import static com.example.supportv1.db.TableField.ADDRESS_DICT_FIELD_PARENTID;
...
//        cursor.close();
        ...
        for (int i = 0; i < size; i++) {
            if (provinceId == provinceList.get(i).id){
                return provinceList.get(i).cities;
            }
        }
        return null;
    }
...
//        for (int i = 0; i < size; i++) {
//            if (cityId == cityList.get(i).id){
//                return cityList.get(i).counties;
//            }
//        }
        return countyList;
    }
