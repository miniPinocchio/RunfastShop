...
/**
 * Utility methods for creating prettier gradient scrims. 中文注释：这个方法主要是用来处理颜色渐变的，能够将颜色变化缓和，不在那么僵硬
 */
public class ScrimUtil {
    ...
    /**
     * Creates an approximated cubic gradient using a multi-stop linear gradient. See <a href="https://plus.google.com/+RomanNurik/posts/2QvHVFWrHZf">this
