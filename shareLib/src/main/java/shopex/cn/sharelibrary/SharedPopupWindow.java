...
public class SharedPopupWindow implements  PlatformActionListener, Handler.Callback, AdapterView.OnItemClickListener {
     ...
     * @param context
     */
    public SharedPopupWindow(final Activity context) {
        this.context=context;
       /** 注册平台信息*/
        SharedInitRegistInfo initRegistInfo=new SharedInitRegistInfo(context);

        LayoutInflater inflater= (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        rootView = inflater.inflate(R.layout.share_layout,null);
        GridView gridView = (GridView) rootView.findViewById(R.id.share_gr);
        ...
        shareWindow = new PopupWindow(rootView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
   ...
   {
       show(view,DEFAULT_VALUE,DEFAULT_VALUE,DEFAULT_VALUE,false);
   }
    public  void  show(View view,int gravity, int x, int y,boolean isShadow)
    {
        ...
        if (this.animation==DEFAULT_VALUE)
        {
            ...
            shareWindow.setAnimationStyle(animation);
        }
        ...
        if (gravity==DEFAULT_VALUE)
        {
            ...
            shareWindow.showAtLocation(view, gravity, x, y);
        }
